  ...
  */
  function SetLanguage($langcode = 'en', $lang_path = 'language/') {
    ...
    $PHPMAILER_LANG = array(
      'provide_address' => '您必須提供至少一個收件人郵箱地址。',
      'mailer_not_supported' => '不支持郵件程序。',
      'execute' => '無法執行： ',
      'instantiate' => '無法實例化郵件功能。',
      'authenticate' => 'SMTP錯誤：無法驗證。',
      'from_failed' => '以下發件人地址失敗：',
      'recipients_failed' => 'SMTP錯誤：以下收件人失敗：',
      'data_not_accepted' => 'SMTP錯誤：數據不被接受。',
      'connect_host' => 'SMTP錯誤：無法鏈接到SMTP主機。',
      'file_access' => '無法訪問文件：',
      'file_open' => '文件錯誤：無法打開文件：',
      'encoding' => '未知編碼：',
      'signing' => '簽名錯誤：',
      'smtp_error' => 'SMTP服務器錯誤：',
      'empty_message' => '郵件內容不能為空',
      'invalid_address' => '郵箱地址無效',
      'variable_set' => '無法設置或重置變量：'
    );
